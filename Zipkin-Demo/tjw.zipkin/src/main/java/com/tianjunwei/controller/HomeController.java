...
public class HomeController {
    ...
    public void db() throws Exception{
		...
		try {
			String url = "jdbc:mysql://localhost:3306/k2_demo?user=root&password=root&useUnicode=true&characterEncoding=UTF8&statementInterceptors=brave.mysql.TracingStatementInterceptor&zipkinServiceName=myDatabaseService";
